 ...
 * @author CesarMatias
 */
public class cEstadoSolicitud implements ActionListener, DocumentListener, KeyListener {

    // variables
    eEstadoSolicitud mod;
    frmFormulario vis;
    ...
    private void iniciar() {
        this.vis.setTitle("Estado Solicitud");
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == this.txtCodigo) {
            if (opAgregar == null && !this.txtCodigo.getText().isEmpty()) {
                ...
                // recuperando datos
                Iterator<eEstadoSolicitud> itEstadoSolicitud = this.mod.recuperaDatos().iterator();

                if (itEstadoSolicitud.hasNext()) {
                    this.mod = itEstadoSolicitud.next();
        ...
        if (e.getSource() == this.vis.btnEliminar) {
            if (JOptionPane.showConfirmDialog(this.vis, "¿Seguro que desea Eliminar?", "CONFIRMAR!",
                ...
                String mensaje = this.mod.eliminarEstadoSolicitud();
                if (mensaje == null) {
        ...
        if (e.getSource() == this.vis.btnGuardar) {
            ...
            if (opAgregar) { // si agregar fue seleccionado TRUE
                mensaje = this.mod.insertarEstadoSolicitud();
            } else { // si agregar fue seleccionado FALSE
                mensaje = this.mod.actualizarEstadoSolicitud();
            }
