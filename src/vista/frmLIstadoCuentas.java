 ...
 * @author CesarMatias
 */
public class frmLIstadoCuentas extends javax.swing.JFrame implements DocumentListener {
...
//        icono de la aplicacion
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        where += " AND cuefecha BETWEEN '" + dateFormat.format(txtFecIni.getDate()) + "' AND '" + dateFormat.format(txtFecFin.getDate()) + "'";
        ...
        try {
            ...
            JasperPrint jp = JasperFillManager.fillReport("src/reporte/rptListadoCuentas.jasper", param, this.mod.cone());
