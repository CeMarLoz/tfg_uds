 ...
 * @author CesarMatias
 */
public class frmLIstadoVentas extends javax.swing.JFrame implements DocumentListener {
...
//        icono de la aplicacion
    ...
    private void btnImprimirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnImprimirActionPerformed
        ...
        where += " AND v.venfecha BETWEEN '" + dateFormat.format(txtFecIni.getDate()) + "' AND '" + dateFormat.format(txtFecFin.getDate()) + "'";

        try {
            HashMap param = new HashMap();
            param.put("P_WHERE", where);
            param.put("P_USER", eLogin.Alias);
            param.put("P_CONDICION", "Contado");
            param.put("P_FECHA", fecha);
            JasperPrint jp = JasperFillManager.fillReport("src/reporte/rptListadoVentas.jasper", param, this.mod.cone());
